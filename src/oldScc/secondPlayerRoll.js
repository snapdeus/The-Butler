...
module.exports = async function botRollSCC(interaction, value) {
    ...
    async function game() {
        ...
        embed.addField(`Roll: `, `${ numOfRolls + 1 } `)
        embed.addField(`Dice: `, `${ newDiceArray } `)
        ...
        if (numOfRolls < 3) {
            //add roll again button and possible end turn button
            const row = new MessageActionRow()
                .addComponents(
                    new MessageButton()
                        ...
                        .setLabel('Roll Again')
                        .setStyle('PRIMARY')
                        .setCustomId(`2NDROLL_` + interaction.user.id)
